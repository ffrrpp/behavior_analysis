...
sbName = swimboutName{nn};
goodswimbouts = fish_in_vid.goodswimbouts;
nframes = goodswimbouts(nn,6) - goodswimbouts(nn,5) + 1;
fishlen_3d = fishlen_all(nn);
...
crop_b = fish_in_vid.b{nn}{2};
crop_s1 = fish_in_vid.s1{nn}{2};
crop_s2 = fish_in_vid.s2{nn}{2};

im_blank = zeros(488,648,'uint8');

for n = 1:nframes
    
    im_b_cropped = fish_in_vid.b{nn}{1}{n};
    im_s1_cropped = fish_in_vid.s1{nn}{1}{n};
    im_s2_cropped = fish_in_vid.s2{nn}{1}{n};
    cb = crop_b{n};
    cs1 = crop_s1{n};
    cs2 = crop_s2{n};
