%% track swimming zebrafish in side view videos

function fish_in_vid = tracking_fs_s(v)
...
% get rid of shadows (by removing the top part of the side movies)
v(1:110,:,:) = 0;
