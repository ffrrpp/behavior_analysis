...
[cen_3d,cen_b,cen_s1,cen_s2,im_b,im_s1,im_s2,crop_b,crop_s1,crop_s2] =...
    calc_center_n_crop(im1_b_original,im1_s1_original,im1_s2_original,P,A);
...
[x1,fval1] = fitbottomview(x0,bw_b,bw_s1,bw_s2,crop_b,crop_s1,crop_s2,F,P,A,lut_bw_b,4,5000);

% [x2,fval2] = fitsideview(x1,bw_b,bw_s1,bw_s2,crop_b,crop_s1,crop_s2,F,P,A,lut_bw_b,lut_bw_s,4,5000);
 
[x,fval] = finetuning(x1,bw_b,bw_s1,bw_s2,crop_b,crop_s1,crop_s2,F,P,A,lut_bw_b,lut_bw_s,4,5000);
