...
function [x,fval] = finetuning(x0,bw_b,bw_s1,bw_s2,crop_b,crop_s1,crop_s2,F,P,A,lut_bw_b,lut_bw_s,ncores,nTrialPoints)
...
problem = createOptimProblem('fmincon','x0',x0,...
    'objective',ObjectiveFunction,'lb', [[-3,-3,-3],-0.1*pi*ones(1,8),0,0,0,0,0] + x0,...
    'ub', [[3,3,3],0.1*pi*ones(1,8),1,0,0,0,0] + x0, 'Aineq', AA, 'bineq', b,...
    'options',opts);
