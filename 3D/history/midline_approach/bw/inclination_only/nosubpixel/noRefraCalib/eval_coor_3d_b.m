function diff = eval_coor_3d_b(x,im_b,im_s1,im_s2,crop_b,crop_s1,crop_s2,F,P,A,lut_bw_b)
...
[coor_b,coor_s1,coor_s2,depth_b,~,~] = calc_proj_w_refra(pt,F,P,A);
...
diff = diff_b + diff_s1*2 + diff_s2*2;
