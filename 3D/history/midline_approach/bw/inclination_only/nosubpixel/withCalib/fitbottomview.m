...
function [x,fval] = fitbottomview(x0,bw_b,bw_s1,bw_s2,crop_b,crop_s1,crop_s2,F,P,A,lut_bw_b,ncores,nTrialPoints)
...
ObjectiveFunction = @(x)eval_coor_3d_b(x,bw_b,bw_s1,bw_s2,crop_b,crop_s1,crop_s2,F,P,A,lut_bw_b);
...
problem = createOptimProblem('fmincon','x0',x0,...
    'objective',ObjectiveFunction,'lb', [[-5,-5,-5],-1*pi*ones(1,8),-pi/4,zeros(1,4)] + x0,...
    'ub', [[5,5,5],1*pi*ones(1,8),pi/4,zeros(1,4)] + x0, 'Aineq', AA, 'bineq', b,...
    'options',opts);
