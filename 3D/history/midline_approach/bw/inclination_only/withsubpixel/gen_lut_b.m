...
ballsize0 = [9.5,6.5,5,4,3,2,2,2,1,1];
% thickness of the sticks in the model
thickness0 = [7.5,5.5,4,3,3,2,2,1,1];
            ...
            for nx = 1:5
                for ny = 1:5
                    ...
                    for a = 1:360
                        ...
                        b_table_bw{n,depth,nseglen,nx,ny,a} = bwmodel;
                    end
                end
            end
        end
