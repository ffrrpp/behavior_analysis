...
% cen_s is the center of fish in the original image

function [bwmodel,diff] = calc_difference_s(im,pt)

% size of the balls in the model
ballsize = [5,4,3.5,3,2.5,2,1.5,1,1,1];
% thickness of the sticks in the model
thickness = [4.5,3.5,3,2.5,2,1.5,1,1,1];
