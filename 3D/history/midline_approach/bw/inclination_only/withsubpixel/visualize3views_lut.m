...
[im_fuse_b,~] = visualize_b_lut(bw_b,crop_b,coor_b,depth_b,b_table_bw);
[im_fuse_s1,~] = visualize_s_lut(bw_s1,crop_s1,coor_s1,depth_s1,s_table_bw);
[im_fuse_s2,~] = visualize_s_lut(bw_s2,crop_s2,coor_s2,depth_s2,s_table_bw);
