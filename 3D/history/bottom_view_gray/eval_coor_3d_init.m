function diff = eval_coor_3d_init(x,im_b,im_s1,im_s2,crop_b,crop_s1,crop_s2,proj_params,lut_b_init,lut_bw_s)
...
[~,diff_b] = calc_difference_b_lut_init(im_b,crop_b,coor_b,lut_b_init);
