...
function [bwmodel,diff] = calc_difference_b_lut_init(im,crop_coor,pt,lut_b_init)
...
for n = 1:9
    ...
    tailpix(max(1,coor_t2-(size_half-1)):min(imageSizeY,coor_t2+(size_half-1)),...
        ...
        lut_b_init{n,at}(max((size_half+1)-coor_t2,1):min(imageSizeY-coor_t2+size_half,size_lut),...
