...
function [cen_3d,cen_b,cen_s1,cen_s2,im_b,bw_b,bw_s1,bw_s2,crop_b,crop_s1,crop_s2] =...
    calc_center_n_crop(im_b,im_s1,im_s2,proj_params)
[bw_b,cen_b] = calc_center_2d(im_b);
[bw_s1,cen_s1] = calc_center_2d(im_s1);
[bw_s2,cen_s2] = calc_center_2d(im_s2);

[im_b,crop_b] = calc_crop(im_b,cen_b);
% normalize im_b
im_b = im_b*(255/max(im_b(:)));
