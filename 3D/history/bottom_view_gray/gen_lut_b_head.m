...
function head_table_cell = gen_lut_b_head()

head_table_cell = cell(20,5,5,360);
imageSizeX = 49;
imageSizeY = 49;
    ...
    for d1 = 1:5
        for d2 = 1:5
            for a = 1:360
                ...
                % size of belly
                len_belly = seglen * 1.8;
                wid_belly = seglen * 0.65;
                ...
                head_table_cell{nseglen,d1,d2,a} = graymodel;
            end
        end
    end
end