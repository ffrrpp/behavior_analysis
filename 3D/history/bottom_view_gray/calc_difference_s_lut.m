...
function [bwmodel,diff] = calc_difference_s_lut(im,crop_coor,pt,lut_bw_s)
...
for n = 1:9
    ...
    tailpix(max(1,coor_t2-(size_half-1)):min(imageSizeY,coor_t2+(size_half-1)),...
        ...
        lut_bw_s{n,seglenidx,dt1,dt2,at}(max((size_half+1)-coor_t2,1):min(imageSizeY-coor_t2+size_half,size_lut),...
