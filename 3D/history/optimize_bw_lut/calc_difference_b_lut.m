...
function [bwmodel,diff] = calc_difference_b_lut(im,crop_coor,pt,lut_bw_b)
...
for n = 1:8
    ...
    tailpix(max(1,coor_t2-(size_half-1)):min(imageSizeY,coor_t2+(size_half-1)),...
        ...
        lut_bw_b{n,seglenidx,at}(max((size_half+1)-coor_t2,1):min(imageSizeY-coor_t2+size_half,size_lut),...
