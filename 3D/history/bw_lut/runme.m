...
% fit bottom view
for n = 1:4
    r = [ones(1,3), 1, ones(1,7),0];
    R = [r;r;r;r*0.1];
    noise = (rand(4,12)-0.5).*R;
    lb = [-5*ones(1,3),-pi,-2*ones(1,7),0];
    ub = [5*ones(1,3),pi,2*ones(1,7),0];
...
% fit side view
for n = 1:4
    r = [0.2*ones(1,3), 0.1, 0.2*ones(1,7),0.2];
    R = [r;r;r;r*0.1];
    noise = (rand(4,12)-0.5).*R;
    lb = [-0.4*ones(1,3),-0.2,-0.4*ones(1,7),-0.4];
    ub = [0.4*ones(1,3),0.2,0.4*ones(1,7),0.4];
