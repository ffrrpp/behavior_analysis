...
function lut_b_tail = gen_lut_b_tail()

lut_b_tail = cell(7,18,5,5,360);
size_lut = 19;
size_half = (size_lut+1)/2;

% size of the balls in the model
ballsize = [3,2,2,2,2,1.5,1.2,1.2,1];
% thickness of the sticks in the model
thickness = [7,6,5.5,5,4.5,4,3.5,3];
        ...
        for d1 = 1:5
            for d2 = 1:5
                ...
                for a = 1:360
                    ...
                    lut_b_tail{n,nseglen,d1,d2,a} = graymodel;
                end
            end
        end
    end
