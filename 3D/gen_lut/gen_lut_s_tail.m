...
function lut_s_tail = gen_lut_s_tail()

lut_s_tail = cell(7,25,5,5,180);
...
ballsize = [2.5,2.4,2.3,2.2,1.8,1.5,1.3,1.2];
% thickness of the sticks in the model
thickness = [8,7,6,5,4,3,2.5,2.5];
        ...
        for d1 = 1:5
            for d2 = 1:5
                ...
                for a = 1:180
                    ...
                    lut_s_tail{n,seglenidx,d1,d2,a} = graymodel;
                end
            end
        end
    end
