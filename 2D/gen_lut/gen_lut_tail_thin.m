...
function tail_table_cell = gen_lut_tail_thin(seglen)

tail_table_cell = cell(7,5,5,720);
imageSizeX = 29;
imageSizeY = 29;
% size of the balls in the model
ballsize = [4,3,1.6,1.5,1,1,1,1,0.8,0.5]*0.6;
% thickness of the sticks in the model
% thickness = [4,3.5,3.2,2.5,2.5,2,2,1.5,1.3];
thickness = [4,3.5,3,2.5,2.5,2.2,2,1.8,1.5]*0.6;
% brightness of the tail
% b_tail = [0.5,0.4,0.35,0.32,0.3,0.25,0.16,0.08];
