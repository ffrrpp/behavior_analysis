...
function [diff,shape_panelty,graymodel] = calc_diff(im,x,lut_head,lut_tail,seglen)
% global x_iter
% global diff_iter
...
shape_panelty = round(dx/curvature*1000);
...
diff = diff_gi + sum(sum(bodypix - im)) +...
    diff_tailtip1 + diff_tailtip2 + oversize_panelty*2;
