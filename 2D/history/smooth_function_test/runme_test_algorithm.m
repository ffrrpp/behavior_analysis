...
fish_in_vid = results_er.fish_in_vid;
goodswimbouts_er = results_er.goodswimbouts_er;
...
parfor i = 1:nswimbouts
    ...
    for n = 1:nframes
        ...
        while err_ct >= 0;
            ...
            fprintf('Working on swimming bout %d (%d/%d frames): %d\n', i, n, nframes, err_ct);
...
save('er_results_20000_noncurv_111184_cp.mat','results');
