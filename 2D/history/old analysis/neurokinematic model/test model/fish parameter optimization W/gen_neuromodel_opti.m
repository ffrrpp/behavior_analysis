...
CA = repmat([0.2,0.3,0.36,0.38,0.35,0.32,0.29,0.26,0.23]',[1,length(time)]); % cross sectional area
C = repmat([0.87,0.8,0.78,0.76,0.7,0.64,0.55,0.4,0.25]',[1,length(time)]); % damping coefficient
