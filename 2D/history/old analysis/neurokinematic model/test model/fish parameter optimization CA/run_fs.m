...
% W0 = [0.98,0.9,0.4,0.3,0.3,0.2,0.15,0.2,0.06]*50;
% C0 = [0.8,0.6,0.6,0.6,0.6,0.5,0.4,0.3,0.2]*50;
% M0 = [0.2,0.8,0.8,0.8,0.8,0.6,0.6,0.5,0.3]*50;

% W0 = [0.72,0.45,0.25,0.14,0.1,0.08,0.06,0.05,0.04]*50;
% C0 = [0.87,0.8,0.78,0.76,0.7,0.64,0.55,0.4,0.25]*50;
% M0 = [0.2,0.3,0.36,0.38,0.35,0.32,0.29,0.26,0.23]*50;
