...
% W0 = [0.98,0.98,0.5,0.25,0.15,0.1,0.07,0.05,0.05]*50;
W0 = [0.98,0.98,0.98,0.98,0.9,0.4,0.17,0.06,0.06]*50;
...
i = 1;
    ...
    noise = round(6*rand(10,ns*3+9))-3;
    x_t = zeros(10,ns*3+9);
    fval_t = zeros(10,1);
    for m = 1:10
    ...
    % second round
    for n = 1:10
        noise = round(2*rand(10,ns*3+9))-1;
        x_t = [zeros(10,ns*3+9);x];
