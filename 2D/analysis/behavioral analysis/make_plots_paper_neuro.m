...
errorbar(x,nanmean(sig_slc),e_sig_slc,'color',blue,'Linewidth',6,'CapSize',10);
errorbar(x,nanmean(sig_llc),e_sig_llc,'color',pink,'Linewidth',6,'CapSize',10);
errorbar(x,nanmean(sig_fs),e_sig_fs,'color',gray,'Linewidth',6,'CapSize',10);
hold off
ax = gca;
ax.LineWidth = 5;
ax.FontSize = 30;
...
errorbar(x,nanmean(tprop_fs),e_tprop_fs,'color',gray,'Linewidth',6,'CapSize',10);
errorbar(x,nanmean(tprop_slc),e_tprop_slc,'color',blue,'Linewidth',6,'CapSize',10);
errorbar(x,nanmean(tprop_llc),e_tprop_llc,'color',pink,'Linewidth',6,'CapSize',10);
hold off
ax = gca;
ax.LineWidth = 5;
ax.FontSize = 30;
